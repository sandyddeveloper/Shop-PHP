...
if (!empty($get_order_id)) {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        $goods = $prod_ids[array_key_first($prod_ids)]['goods'];

        $goods_display = implode("\n", $goods);
    } else {
    ...
    // Display this message only if it's not a direct lookup
...
<head>
   ...
   body {
    ...
    .container {
        ...
        width: 80%; /* Container width to ensure responsiveness */
        max-width: 800px;
    }
    textarea {
...
<div class="container">
    ...
    <form method="post">
        <label for="get_order_id">Enter Unique ID:</label><br>
